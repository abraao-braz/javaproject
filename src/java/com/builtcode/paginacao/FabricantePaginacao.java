 ...
 * @author Fabio
 */
public class FabricantePaginacao{
    private List<Fabricante> dados;
    private Paginacao paginacao;
    private Mensagem erro;
    
    public FabricantePaginacao(){
        
    }
    
    public FabricantePaginacao(List<Fabricante> dados, Paginacao paginacao, Mensagem erro){
        this.dados = dados;
     ...
     */
    public void setDados(List<Fabricante> dados) {
        this.dados = dados;
    }
    
    public List<Fabricante> getDados() {
        return this.dados;
    }    
